// Call the angular module called turtleFacts that was created in js/app.js then attach the controller quizCtrl to it.
(function(){
     ...
     * quizMetrics is a service we created that is defined in js/factory/quiz.js */
    function QuizController(quizMetrics, DataService){
        ...
        function setActiveQuestion(index){
            ...
            if(index === undefined){
                ...
                // Data was passed into the function therefore Set activeQuestion to the index of the button pressed
        ...
        function questionAnswered(){
            ...
            for(var x = 0; x < quizLength; x++){
             ...
             // There are still questions to answer so increment to next unanswered question using the setActiveQuestion method
